"""
Django settings for freelance_actors project.
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "django-insecure-r0e7g#f#-(!-fw$tzt956%h3wkdb9p!z$&r3k41*2w_pkjtq0-")
...
ROOT_URLCONF = 'freelance_actors.urls'
...
WSGI_APPLICATION = 'freelance_actors.wsgi.application'
